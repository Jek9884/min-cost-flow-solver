...
%
function [x,e,r_norm] = our_gmres(D, E, P, b, starting_point, threshold, reorth_flag)
  ...
  r = calculate_the_residual_optimized(D, E, b, starting_point);
  ...
  for k = 1:m
    ...
    [H(1:k+1, k), Q(:, k+1)] = lanczos(D, E, Q, k, reorth_flag);
    ...
    r = calculate_the_residual_optimized(D, E, b, x);
...
%         v - TODO
%
function [h, v] = lanczos(D, E, Q, k, reorth_flag)
  q1 = Q(1:size(D,1), k);
...
function r = calculate_the_residual_optimized(D, E, b, input_vector)
